...
function App() {
  ...
  return (
    <div className="container">
      <img className='desktop-banner' src="images/background-pattern-desktop.svg" alt="desktop banner"/>
      <img src="images/background-pattern-mobile.svg" alt="" className="mobile-banner" />
        ...
        <div className="faq-section">
          ...
          <div className="lists lists-1">
            <div className="mini">
              ...
              <img className={`p-1 ${!active ? '' : 'hidden'}`} src="/images/icon-plus.svg" alt="plus" />
              <img className={`p-1 ${active ? '' : 'hidden'}`} src="/images/icon-minus.svg" alt="minus" />
            </div>
          ...
          <div className="lists lists-2">
            <div className="mini">
              ...
              <img className={`p-2 ${!active1 ? '' : 'hidden'}`} src="/images/icon-plus.svg" alt="plus" />
              <img className={`p-2 ${active1 ? '' : 'hidden'}`} src="/images/icon-minus.svg" alt="minus" />
            </div>
          ...
          <div className="lists lists-3">
            <div className="mini">
              ...
              <img className={`p-3 ${!active2 ? '' : 'hidden'}`} src="/images/icon-plus.svg" alt="plus" />
              <img className={`p-3 ${active2 ? '' : 'hidden'}`} src="/images/icon-minus.svg" alt="minus" />
            </div>
          ...
          <div className="lists lists-4">
            <div className='mini'>
              ...
              <img className={`p-4 ${!active3 ? '' : 'hidden'}`} src="/images/icon-plus.svg" alt="plus" />
              <img className={`p-4 ${active3 ? '' : 'hidden'}`} src="/images/icon-minus.svg" alt="minus" />
            </div>
